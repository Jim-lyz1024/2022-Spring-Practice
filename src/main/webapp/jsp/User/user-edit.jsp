...
<rapid:override name="frame-content">
	...
	<br>
	<br>
	<form class="layui-form" action="admin/update" id="userForm" method="post"
			...
			<div class="layui-input-inline">
				<div class="layui-upload">
					<div class="layui-upload-list" id="localImag">
						<img src="admin/photo/${u.userId}" class="layui-upload-img" id="demo1" width="100" height="100">
					</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="userNickname" required placeholder=""
					value="${u.userNickname}" autocomplete="off" min="2" max="10" class="layui-input">
			</div>
			<div class="layui-form-mid layui-word-aux"></div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="email" name="userEmail" id="userEmail" required
					lay-verify="userEmail" class="layui-input" value="${u.userEmail}"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="url" name="userUrl" placeholder="" value="${u.userUrl }" class="layui-input">
			</div>
		</div>
